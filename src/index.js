...
//ACCOUNT PAGE: FAADHIL'S PART (START)

import { Profile } from './account.js';
import { Recipes } from './account.js';

//ACCOUNT PAGE: FAADHIL'S PART (END)
...
const App = () => {
  ...
  return (
    <>
      ...
      {isSearching ? <Profile /> : <SearchBar onSearchingStateChange={setSearching} />}
    </>
